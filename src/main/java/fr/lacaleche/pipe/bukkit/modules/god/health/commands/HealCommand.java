package fr.lacaleche.pipe.bukkit.modules.god.health.commands;
    ...
    public static class Reasons {
        ...
        public static class Add {
            ...
            public void completer(Completer completer) {
                if (completer.index() == 1) {
                    ...
                    List<EntityRegainHealthEvent.RegainReason> blackList = CalecheCore.get().getCentralModuleManager().getModule(HealthModule.class).getReasons();
        ...
        public static class Remove {
            ...
            public boolean execute(Command<CommandSender> command) {
                ...
                module.removeRegainReason(reason);
